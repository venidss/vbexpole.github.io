    ...
    sections: [
      {
        ...
        content: "Step-by-step guide to create the calculator application",
        steps: [
  ...
  },
  {
    ...
    sections: [
      {
        ...
        content: "Setting up the database schema for student management",
    ...
    Active BIT
      ...
      },
      {
        ...
        content: "Complete implementation of the Student class with data access functionality:",
...
End Class`
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Implementation",
        content: "Implementation of the InventoryItem and InventoryManager classes for handling inventory management:",
...
End Class`
  ...
  },
  {
    ...
    sections: [
      ...
      {
        title: "Implementation",
        content: "Implementation of a File Manager with drag & drop and asynchronous operations:",
    ...
    Handles btnCopy.Click
        Try
            For Each item As ListViewItem In lstFiles.SelectedItems
                Dim source: String = item.Tag.ToString()                Dim dest: String = Path.Combine(txtDestination.Text, _
                    item.Text)
...
End Class`
      ...
      {
        title: "Key Features",
        content: "Main features of the File Manager application:",
        list: [
